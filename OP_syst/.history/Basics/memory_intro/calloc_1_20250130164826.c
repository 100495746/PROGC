...
/* 
In C, dynamic memory allocation allows you to allocate memory at runtime instead of compile-time. This is useful when:
	•	You don’t know the exact memory size needed in advance.
	•	You need a resizable array or a flexible data structure. 
